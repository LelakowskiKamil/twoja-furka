...
insert into user_detail(email, enabled, firstname, lastname, password, phone, username) values
(
 'kamil@lelakowski.pl', true, 'Kamil','Lelakowski', '!Haslo123', '123123123','Lelakowsky'
);

insert into offer(title, model_id, body_style, fuel_type, year, mileage, engine_size, engine_power, doors, color, description, price, user_id, image_url) values
                                                                                                                                                                 (
                                                                                                                                                                     'Nissan Primera P11.144', 10, 1, 1, 2000, 152000, 1.6, 100, 5, 1,
                                                                                                                                                                 ...
                                                                                                                                                                 (
                                                                                                                                                                     'Nissan Bluebird', 13, 2, 2, 1988, 352000, 2.0, 75, 4, 2,
                                                                                                                                                                 ...
                                                                                                                                                                 (
                                                                                                                                                                     'BMW 316 aka Dresowóz Klasyk', 59, 2, 1, 1991, 452000, 1.8, 110, 4, 3,
                                                                                                                                                                 ...
                                                                                                                                                                 (
                                                                                                                                                                     'Honda Jazz zadbana', 34, 1, 2, 2012, 17000, 1.2, 90, 3, 4,
